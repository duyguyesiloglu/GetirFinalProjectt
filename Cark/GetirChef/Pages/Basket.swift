...
//
// ... Existing CustomShadowImageView and CustomLabelView classes ...
...
class Page3ViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            foodImageView.heightAnchor.constraint(equalTo: view.widthAnchor, multiplier: 0.8), // Half the width of the view
    ...
    private func setupBottomView() {
        ...
        addButton.titleLabel?.font = UIFont(name: "OpenSans-Bold", size: 24)
...
extension Page3ViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return 4 // This should be the number of items in your data source
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        switch indexPath.item {
            case 0:
                cell.configure(with: "yengec.png", price: "€5,00", productName: "Yengeç Surimi", attribute: "175 gr")
            case 1:
                cell.configure(with: "amoy", price: "€3,00", productName: "Amoy Soya Sosu", attribute: "750 ml")
            case 2:
                cell.configure(with: "nori", price: "€4,25", productName: "Sushi Nori", attribute: "50 sheet")
            case 3:
                cell.configure(with: "mat", price: "€10,00", productName: "Sushi Mat", attribute: "-")
            default:
                break
            }
...
extension Page3ViewController: UICollectionViewDelegateFlowLayout {
