...
class TcaoCell: UICollectionViewCell {
    
    static let identifier = "tacoCollectionViewCell" // Ensure this identifier is unique and correct
...
class TacoViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        foodImageView.image = UIImage(named: "7") // Replace with your actual image name
...
extension TacoViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        switch indexPath.item {
            case 0:
            cell.configure(with: "taco", price: "€8,00", productName: "Taco Shell", attribute: "6 pieces")
            case 1:
                cell.configure(with: "meat", price: "€8,00", productName: "Meat", attribute: "500 gr")
            case 2:
            ...
            case 4:
            cell.configure(with: "cheddar", price: "€4,50", productName: "Aç Bitir Cheddar", attribute: "200 gr")
            case 5:
            cell.configure(with: "biber", price: "€3,25", productName: "Pepper", attribute: "500 gr")
            case 6:
            cell.configure(with: "salsa", price: "€4,00", productName: "Salsa Dip", attribute: "400 gr")
            case 7:
            cell.configure(with: "baharat", price: "€1,00", productName: "Taco Spice", attribute: "100 gr")
...
extension TacoViewController: UICollectionViewDelegateFlowLayout {
