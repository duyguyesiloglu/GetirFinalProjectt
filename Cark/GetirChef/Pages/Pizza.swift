...
class PizzaCell: UICollectionViewCell {
    ...
    static let identifier = "pizzaCollectionViewCell" // Ensure this identifier is unique and correct
...
class PizzaViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        foodImageView.image = UIImage(named: "pizza.png") // Replace with your actual image name
...
extension PizzaViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return 9 // This should be the number of items in your data source
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        switch indexPath.item {
            case 0:
            cell.configure(with: "taban", price: "€8,00", productName: "Pizza Base", attribute: "4 pieces")
            case 1:
            ...
            case 5:
            cell.configure(with: "barbeku", price: "€3,25", productName: "Barbeque", attribute: "350 gr")
            case 6:
            cell.configure(with: "sosis", price: "€10,00", productName: "Pınar Sassuage", attribute: "400 gr")
            case 7:
            cell.configure(with: "pizzasos", price: "€3,00", productName: "Pizza Sauce", attribute: "100 ml")
            case 8:
