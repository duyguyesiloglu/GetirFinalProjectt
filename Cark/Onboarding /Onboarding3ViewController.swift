...
class Onboarding3ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        titleLabel.text = "Food Ingredients without List"
        titleLabel.numberOfLines = 2 // Allows label to have up to two lines
        titleLabel.lineBreakMode = .byWordWrapping // Breaks lines by words, not characters
        titleLabel.textAlignment = .center
       
        titleLabel.heightAnchor.constraint(greaterThanOrEqualToConstant: titleLabel.font.lineHeight * 2).isActive = true
        titleLabel.sizeToFit()
        titleLabel.font = UIFont(name: "Roboto-BoldItalic", size: 30)
        titleLabel.textColor = UIColor(named: "moru")
        ...
        let welcomeLabel = UILabel()
                ...
                welcomeLabel.text = "Easy recipes, fast food, you can tell all the ingredients with one click, spin the wheel and try it"
