...
class Onboarding1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Create the imageView to display the base image
        ...
        titleLabel.text = "Deliciousness Delivered"
        ...
        imageView.image = UIImage(named: "order-food.png")
        ...
        let welcomeLabel = UILabel()
                ...
                welcomeLabel.text = "Get set for a gourmet adventure that delivers to your door"
